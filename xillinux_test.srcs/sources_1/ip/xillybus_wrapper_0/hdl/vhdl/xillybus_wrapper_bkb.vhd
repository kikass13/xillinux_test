...
entity xillybus_wrapper_bkb_rom is 
    generic(
             DWIDTH     : integer := 100; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 13
...
architecture rtl of xillybus_wrapper_bkb_rom is 
...
entity xillybus_wrapper_bkb is
    generic (
...
architecture arch of xillybus_wrapper_bkb is
    component xillybus_wrapper_bkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    xillybus_wrapper_bkb_rom_U :  component xillybus_wrapper_bkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
